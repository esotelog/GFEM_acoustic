...
code_parameters::code_parameters():
  ...
  input_mesh("topo_mesh_neg_8h.msh"),
  refinement (4),
  source_refinement(2),
  total_time (0.65),
  time_step (0.00045),
...
void ParameterReader::declare_parameters()
{
  ...
  prm. enter_subsection("Discretization");
  {
    ...
    prm.declare_entry ("source refinement",
                        std::to_string(param_input.source_refinement),
                        Patterns::Integer(0),
                        "source refinement,  (integer)"
                        );
...
void ParameterReader::pass_parameters()
{
   ...
   prm.enter_subsection("Discretization");
      ...
      param_input.source_refinement = prm.get_integer("source refinement");
